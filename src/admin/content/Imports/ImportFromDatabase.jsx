...
export default function ImportFromDatabasePage() {
  ...
  return (
    ...
    >
      <Card
        sx={{
          width: { xs: '100%', sm: 400 }, // full width on mobile, fixed 400px on PC
          maxWidth: 400, // max width so it doesn't stretch on wide screens
          borderRadius: 2,
          boxShadow: 3,
          overflow: 'hidden',
        }}
      ...
      <Box sx={{ mt: 3, width: { xs: '100%', sm: 'auto' }, maxWidth: 400 }}>
        <Button
          ...
          sx={{
            ...
            width: { xs: '100%', sm: 'auto' }, // full width on mobile, auto on PC
          }}
        >
          Submit
        </Button>
